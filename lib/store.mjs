...
let db = { personas: [], episodes: [], accounts: [], explainers: [], creditLedger: [], webhookEvents: [], uploads: [], brandKits: [], feeds: [], integrations: [] };
...
export async function initStore() {
  ...
  db.accounts ||= []; db.explainers ||= []; db.creditLedger ||= []; db.webhookEvents ||= []; db.uploads ||= []; db.brandKits ||= []; db.feeds ||= []; db.integrations ||= [];
