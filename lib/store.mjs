...
let db = { personas: [], episodes: [], accounts: [], explainers: [], creditLedger: [], webhookEvents: [], uploads: [] };
...
export async function initStore() {
  ...
  db.accounts ||= []; db.explainers ||= []; db.creditLedger ||= []; db.webhookEvents ||= []; db.uploads ||= [];
...
export async function copyExplainerForRestart(item) {
  ...
  for (const field of ['startedAt','endedAt','error','video','captions','transcript','actions','workflowRunId','creditsCharged']) delete restarted[field];
