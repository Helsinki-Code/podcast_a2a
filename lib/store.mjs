...
let db = { personas: [], episodes: [], accounts: [], explainers: [], creditLedger: [], webhookEvents: [], uploads: [], brandKits: [] };
...
export async function initStore() {
  ...
  db.accounts ||= []; db.explainers ||= []; db.creditLedger ||= []; db.webhookEvents ||= []; db.uploads ||= []; db.brandKits ||= [];
