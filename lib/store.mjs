...
export async function copyEpisodeForRestart(item) {
  ...
  for (const field of ['startedAt','endedAt','error','video','mp4','captions','quality','renderedAt','videoStatus','videoError','workflowRunId','videoWorkflowRunId','creditsCharged']) delete restarted[field];
